...
// TODO: Create spotify playlist (from 50 at first)
// TODO: Set number of items to fetch
...
function App() {
  ...
  // Spotify auth params
  const spotify_client_id = '4a05eb799c7d4e0eb8a806484caf24d8';
  // const spotify_client_secret = '97b3d46ca088440da2adee1d4686ad92';
  ...
  // takes a Spotify playlist ID and an array of URIs and adds them to a spotify playlist
  async function addSpotifyTracksToPlaylist(playlistID, spotifyUriArray){
    console.log(spotifyUriArray.toString())
    const addTracksResponse = await axios.post(`https://api.spotify.com/v1/playlists/${playlistID}/tracks?uris=${spotifyUriArray.toString()}`, {},
    {
      headers: {
        "Accept": "application/json",
        "Content-Type": "application/json",
  ...
  // Clear spotify token and remove from window
  function logout() {
    setSpotifyToken("")
  ...
  // Toggle HTML theme ID
  function toggleTheme(){
    setTheme((curr)=> (curr === "light" ? "dark" : "light") )
  }

  // ComponentDidMount Sets spotify token..?
  useEffect(() => {
